...
public class ProductApiCallerImplS implements ProductApiCaller {

	private String basePath;
	private Gson gson;

	// https://dummyjson.com/
	public ProductApiCallerImplS(String basePath) {
	...
	public List<String> getAllProductsCategories() throws IOException, InterruptedException, ApiCallException {
		...
		List<String> categories = gson.fromJson(response.body(), new TypeToken<List<String>>() {
		}.getType());
		return categories;
	}
